  ...
  return (
    <div className="relative w-44 h-44 sm:w-60 sm:h-60">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-full bg-gradient-to-b from-maroon-dark/92 to-maroon-deep/90 border border-gold/40 shadow-[0_0_40px_rgba(213,175,55,2)] flex items-center justify-center">
          <span className="font-script gold-text-gradient leading-none flex flex-col items-center">
            <span className="text-4xl sm:text-4xl">M</span>
            <span className="text-sm sm:text-base leading-none my-0.8">&amp;</span>
            <span className="text-4xl sm:text-4xl">P</span>
          </span>
        </div>
      </div>
    </div>
    ...
    <AnimatePresence onExitComplete={onComplete}>
      {visible && (
        ...
        >
          ...
          <div className="preloader-couple absolute inset-x-0 bottom-0 z-[5] flex items-end justify-between pointer-events-none px-2 sm:px-8">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-36 h-36 sm:w-64 sm:h-64 bg-gold/15 blur-[80px] rounded-full" />
              <motion.img
                src="/cartoon/groom.png"
                alt={weddingConfig.couple.groomName}
                animate={{ y: [0, -8, 0] }}
                transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
                className="relative h-[17vh] sm:h-[42vh] lg:h-[52vh] w-auto object-contain drop-shadow-[0_20px_35px_rgba(0,0,0,0.5)] select-none"
                draggable={false}
              />
            </motion.div>
          ...
          {/* ---- Content ---- */}
          <div className="relative z-10 flex flex-col items-center text-center px-6 pb-24 pt-16 sm:pt-16 lg:pt-20">
            ...
            <motion.h1
              ...
              className="mt-5 sm:mt-7 font-serif text-2xl sm:text-5xl leading-tight gold-text-gradient"
            >
              {weddingConfig.couple.brideName}
              <span className="mx-2 sm:mx-3 text-gold/60 font-script text-xl sm:text-3xl">&amp;</span>
            ...
            {/* Progress line */}
            <div className="relative mt-4 sm:mt-5 w-56 sm:w-72 h-[3px] rounded-full bg-maroon-light/40 overflow-hidden">
              <div
